...
/** @lends Stats */
{
    ...
    update: function(pages)
    {
        ...
        var timingsTotals = ss.calcTimingsTotals(pages);
        ...
        var contentTotals = ss.calcContentTotals(pages);
        ...
        var trafficTotals = ss.calcTrafficTotals(pages);
        ...
        console.log(trafficPie.data);

        var cacheTotals = ss.calcCacheTotals(pages);
